...
export const metadata = {
  ...
  description: 'Especialistas em comércio exterior, supply chain e logística internacional. 35 anos integrando estratégia, operações e resultados para empresas que desejam expandir globalmente.',
  keywords: [
    ...
    'Redução de custos em importação',
    'Automação de processos em comex',
    'Análise de dados em comex',
    'Desenvolvimento de negócios internacionais'
  ],
  openGraph: {
    title: 'OLV Internacional | Consultoria em Comércio Exterior',
    description: 'Especialistas em comércio exterior, supply chain e logística internacional. 35 anos de experiência.',
    url: 'https://olv-site-next-nyti.vercel.app/',
    type: 'website'
  },
  twitter: {
