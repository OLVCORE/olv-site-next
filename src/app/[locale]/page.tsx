...
export const metadata = {
  title: 'OLV Internacional | Consultoria em Comércio Exterior e Logística 3PL/4PL',
  description: 'Especialistas em importação, exportação e logística internacional. Reduza custos, simplifique operações e expanda globalmente com segurança. Suporte completo do Radar SISCOMEX ao embarque para PMEs.',
  keywords: [
    ...
    'Comex sem mistérios',
    'Consultoria em Comércio Exterior para PME',
  ...
  openGraph: {
    title: 'OLV Internacional | Consultoria em Comércio Exterior e Logística 3PL/4PL',
    description: 'Especialistas em importação, exportação e logística internacional. Reduza custos, simplifique operações e expanda globalmente com segurança. Suporte completo do Radar SISCOMEX ao embarque para PMEs.',
    url: 'https://olvinternacional.com.br/pt-BR',
    type: 'website',
    images: [
      {
        url: 'https://olvinternacional.com.br/images/BANNER-HOME.jpeg',
        width: 1200,
        height: 630,
        alt: 'OLV Internacional - Consultoria em Comércio Exterior'
      }
    ]
  },
  twitter: {
    ...
    title: 'OLV Internacional | Consultoria em Comércio Exterior e Logística 3PL/4PL',
    description: 'Especialistas em importação, exportação e logística internacional. Suporte completo do Radar SISCOMEX ao embarque.',
    images: ['https://olvinternacional.com.br/images/BANNER-HOME.jpeg']
  }
};

// Componente interno para a página principal
const HomePageContent = ({ locale }: { locale: Locale }) => {
  // Array com dados das plataformas do ecossistema
  const plataformas = [
    {
      id: "stratevo",
      logo: "/images/stratevo-logo.jpeg",
      nome: "STRATEVO",
      link: `/${locale}/stratevo`,
    },
    {
      id: "exceltta",
      logo: "/images/exceltta-logo.jpeg",
      nome: "EXCELTTA",
      link: `/${locale}/exceltta`,
    },
    {
      id: "connecta",
      logo: "/images/connecta-logo.jpeg",
      nome: "OLV CONNECTA",
      link: `/${locale}/connecta`,
    },
    {
      id: "engage",
  ...
  return (
    <MainLayout locale={locale}>
      <div className="container mx-auto py-12">
        ...
        {/* Seção de Plataformas do Ecossistema */}
        <section className="ecosystem-platforms-section mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">Plataformas do Ecossistema OLV</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 mb-8">
            {plataformas.map((plataforma) => (
              <div key={plataforma.id} className="text-center">
                <Link href={plataforma.link} className="block group">
                  <div className="bg-slate-800 rounded-lg p-4 transition duration-300 hover:bg-slate-700">
                    <div className="relative w-16 h-16 mx-auto mb-3 rounded-full overflow-hidden border-2 border-gray-700 group-hover:border-blue-500">
                      <Image 
                        src={plataforma.logo} 
        ...
        <section className="solutions-section mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-slate-800 p-8 rounded-lg shadow-md">
              ...
              <Link href={`/${locale}/solucoes`} className="text-blue-400 hover:text-blue-300">
                Ver mais soluções →
              </Link>
            </div>
