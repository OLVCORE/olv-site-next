  ...
  return (
    <html lang={params.locale} suppressHydrationWarning>
      <head>
        ...
        <meta name="language" content={params.locale === 'pt-BR' ? 'Portuguese' : 'English'} />
        ...
        <meta property="og:url" content={`https://olvinternacional.com.br/${params.locale}`} />
        <meta property="og:image" content="https://olvinternacional.com.br/images/olv-logo.jpeg" />
        <meta property="og:locale" content={params.locale === 'pt-BR' ? 'pt_BR' : 'en_US'} />
