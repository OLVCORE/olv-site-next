...
export default function ConnectaPage({ params }: PageProps) {
  ...
  return (
    <MainLayout locale={locale}>
      <PlatformLayout
        ...
        platformLogo="/images/connecta.jpg"
        platformDescription="Conectamos sua empresa ao mundo"
        platformColor="#0052cc"
      >
