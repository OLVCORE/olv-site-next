...
export default function VenturesPage({ params }: PageProps) {
  ...
  return (
    <MainLayout locale={locale}>
      <PlatformLayout
        ...
        platformDescription="Investimentos e Aceleração para Startups de Comércio Global"
        platformColor="#7b1fa2"
      >
