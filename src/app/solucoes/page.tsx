...
export const metadata = {
  title: 'Soluções em Comércio Exterior | Importação, Exportação e Logística 3PL/4PL',
  description: 'Consultoria especializada em importação, exportação e logística internacional. Reduza custos, simplifique processos e expanda globalmente com nosso suporte completo do Radar SISCOMEX ao embarque.',
  keywords: [
  ...
  openGraph: {
    ...
    url: 'https://olvinternacional.com.br/solucoes',
    type: 'website',
    images: [
      {
        url: 'https://olvinternacional.com.br/images/solutions-banner.jpeg',
        width: 1200,
        height: 630,
        alt: 'Soluções OLV Internacional em Comércio Exterior'
      }
    ]
  },
  twitter: {
    ...
    images: ['https://olvinternacional.com.br/images/solutions-banner.jpeg']
  }
};
