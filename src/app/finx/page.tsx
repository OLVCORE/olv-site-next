...
export const metadata = {
  ...
  description: 'Plataforma especializada em gestão financeira para operações de comércio exterior. Controle de câmbio, fluxo de caixa internacional e planejamento tributário.',
  keywords: [
    'Gestão Financeira Comércio Exterior',
    'Controle de Câmbio',
    ...
    'Otimização Fiscal Comex',
    'Custos de Importação',
    'Precificação para Exportação'
  ],
  openGraph: {
    title: 'FINX | Gestão Financeira para Comércio Exterior | OLV Internacional',
    description: 'Controle financeiro especializado para operações internacionais, gestão de câmbio e otimização tributária em comércio exterior.',
    url: 'https://olv-site.vercel.app/finx',
    type: 'website'
  },
  twitter: {
    card: 'summary_large_image',
    title: 'FINX | Gestão Financeira Internacional',
    description: 'Controle financeiro para operações globais e gestão eficiente de câmbio.'
  }
};
  ...
  return (
    <MainLayout locale={locale}>
      <PlatformLayout
        ...
        platformDescription="Controle financeiro para operações globais"
        platformColor="#00796b"
      >
